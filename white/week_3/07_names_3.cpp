...
class Person {
public:
  Person(const std::string &first_name_, const std::string &last_name_, int year_of_birth_) {
    year_of_birth = year_of_birth_;
    first_names[year_of_birth] = first_name_;
    last_names[year_of_birth] = last_name_;
  }
...
private:
  ...
  map<int, std::string> first_names;
  map<int, std::string> last_names;
  int year_of_birth;
};
